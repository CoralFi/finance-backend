const getCodeEmailBody = (email: string, code: string | number): string => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background-color: #262626; padding: 25px; border-radius: 12px; border-left: 4px solid #16a34a; color: #ffffff;">
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #ffffff !important;">
          Para continuar con tu proceso, introduce el siguiente código de verificación. El código expira en 15&nbsp;minutos.
        </p>
