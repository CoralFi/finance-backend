...
function getRampType(tx) {
    const fiatMethods = [
        "ACH", "WIRE", "SEPA", "SWIFT", "AR_TRANSFERS_3", "MX_SPEI", 
        "BR_TED_DOC_PIX", "CA_INTERAC", "GB_BACS_CHAPS_FPS", "AU_BECS", "PE_CCE", "CL_TEF", "HK_HKICL_CHATS_ECG", "ID_SKN_RTGS", "IL_ZAHAV"];
    ...
    if (tx.source?.sourcePaymentAccountId === tx.destination?.destinationPaymentAccountId) {
        return "swap";
    }
