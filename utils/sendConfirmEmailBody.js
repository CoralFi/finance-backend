// Obtiene el HTML para el correo de confirmación de email
const getSendConfirmEmailBody = (name, confirmLink) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background-color: #262626; padding: 25px; border-radius: 12px; border-left: 4px solid #16a34a; color: #ffffff;">
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #ffffff !important;">¡Bienvenido a CoralFinance! Para completar tu registro y activar tu cuenta, necesitamos verificar tu dirección de correo electrónico.</p>
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #ffffff !important;">Una vez que confirmes tu correo, podrás acceder a todas las funcionalidades de tu cuenta CoralFinance.</p>
        ...
        <p style="font-size: 14px; line-height: 1.6; color: #ffffff !important; margin-top: 20px;">Si no creaste una cuenta en CoralFinance, puedes ignorar este mensaje de forma segura.</p>
      </div>
