  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px; background-color: #16a34a; padding: 20px; border-radius: 8px;">
        <h1 style="color: #ffffff; margin: 0;">CoralFinance</h1>
        <p style="color: #ffffff; margin: 5px 0 0 0; font-size: 16px; opacity: 0.9;">Código de Verificación</p>
      </div>

      <div style="background-color: #262626; padding: 25px; border-radius: 12px; border-left: 4px solid #16a34a; color: #ffffff;">
        <h2 style="margin-top: 0; margin-bottom: 20px;">Hola ${email},</h2>
        <p style="font-size: 15px; line-height: 1.6;">Para continuar con tu proceso, introduce el siguiente código de verificación. El código expira en 15&nbsp;minutos.</p>
        ...
        <p style="font-size: 14px; line-height: 1.6;">Si no solicitaste este código, puedes ignorar este mensaje de forma segura.</p>
      </div>
